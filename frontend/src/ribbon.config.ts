    ...
    groups: [
      ...
      },
      {
        ...
        actions: [
          ...
          { key: 'scholarships', label: 'Scholarships', icon: GraduationCap, accessLevel: 2, placeholder: true },
          { key: 'fin-reports', label: 'Reports', icon: TrendingUp, accessLevel: 2, placeholder: true },
        ],
      },
    ],
  },
