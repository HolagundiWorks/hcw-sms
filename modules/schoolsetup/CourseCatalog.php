...
if (clean_param($_REQUEST['modfunc'], PARAM_ALPHAMOD) == 'choose_course') {
    ...
    if ($_REQUEST['print'] != 'list') {
        echo "<FORM name=search  class=form-horizontal id=search action=ForExport.php?modname=$_REQUEST[modname]&modfunc=print&marking_period_id=" . $_REQUEST['marking_period_id'] . "&_hcwsms_PDF=true&report=true&print=list method=POST target=_blank>";
...
function CreateList($dli = '', $pli = '', $sli = '', $cli = '', $mp = '', $mp_name = '')
{
    ...
    $html = "<b>" . $heading . "</b><br>
        <A HREF=" . str_replace('Modules.php', 'ForExport.php', $PHP_tmp_SELF) . "&create_excel=true&LO_save=1&_hcwsms_PDF=true > <IMG SRC=assets/download.png border=0 vspace=0 hspace=0></A>
        <br>";
    $html .= "<table width=100%  style=\" font-size:12px;\" >";
    $html .= "<tr><td  style=\"font-size:15px; font-weight:bold;\">" . GetSchool(UserSchool()) . "<div style=\"font-size:12px;\">" . _studentSchedulesReport . "</div></td><td align=right style=\"padding-top:10px;\">" . ProperDate(DBDate()) . "<br />" . _poweredBy . " HCW-SMS</td></tr><tr><td colspan=2 style=\"border-top:1px solid #333;\">&nbsp;</td></tr></table>";
    ...
    if ($_REQUEST['print'] == 'list') {
        ...
        echo "<tr><td  style=\"font-size:15px; font-weight:bold;\">" . GetSchool(UserSchool()) . "<div style=\"font-size:12px;\">" . _courseCatalog . "</div></td><td align=right style=\"padding-top:5px;\">" . ProperDate(DBDate()) . "<br />" . _poweredBy . " HCW-SMS</td></tr><tr><td colspan=2 style=\"border-top:1px solid #333;\">&nbsp;</td></tr></table>";
    }
